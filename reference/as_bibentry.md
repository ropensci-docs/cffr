...
`DESCRIPTION` files and other sources). The inverse transformation from
a `bibentry` object to
[`cff_ref_lst`](https://docs.ropensci.org/cffr/reference/cff_class.md)
can be performed with the corresponding
...
- x:
  ...
  - A missing or `NULL` value, which retrieves the `DESCRIPTION` file
    from your in-development package.
...
[`cff`](https://docs.ropensci.org/cffr/reference/cff.md) object and maps
the metadata to BibTeX as described in
...
[`encoded_utf_to_latex()`](https://docs.ropensci.org/cffr/reference/encoded_utf_to_latex.md)
...
#> <https://r6.r-lib.org>.
#> 
#> Ooms J (2026). “V8: Embedded JavaScript and WebAssembly Engine for R.”
...
#> Generation in R.” doi:10.32614/CRAN.package.knitr
#> <https://doi.org/10.32614/CRAN.package.knitr>. Suggests,
#> <https://yihui.org/knitr/>.
#> 
#> Ooms J (2025). “jsonlite: A Simple and Robust JSON Parser and Generator
#> for R.” doi:10.32614/CRAN.package.jsonlite
...
#> A, Wickham H, Cheng J, Chang W, Iannone R (2026). “rmarkdown: Dynamic
#> Documents for R.” doi:10.32614/CRAN.package.rmarkdown
#> <https://doi.org/10.32614/CRAN.package.rmarkdown>. Suggests,
#> <https://pkgs.rstudio.com/rmarkdown/>.
#> 
#> Wickham H (2026). “testthat: Unit Testing for R.”
