...
- ...:
  ...
  Named arguments used to create a `cff` object. If no arguments are
  supplied (the default behavior), a minimal valid `cff` object is
  created.
...
cff_validate(test)
#> ══ Validating CFF ══════════════════════════════════════════════════════════════
#> ✖ Validation failed. This <cff> object has 2 validation errors:
