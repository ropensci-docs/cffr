...
#> ══ Validating CFF ══════════════════════════════════════════════════════════════
#> ✔ /github/home/R/x86_64-pc-linux-gnu-library/4.6/cffr/examples/CITATION_complete.cff is valid.
...
#> ══ Validating CFF ══════════════════════════════════════════════════════════════
#> ✖ Validation failed. /github/home/R/x86_64-pc-linux-gnu-library/4.6/cffr/examples/CITATION_error.cff has 18 validation errors:
...
#> Error in cff_validate(system.file("CITATION", package = "cffr")) : 
#>   `x` is not a `*.cff` file.
#> ℹ Supply a <cff> object or a `*.cff` file path.
```
