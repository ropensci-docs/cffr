...
- For questions, start with [Posit Community](https://forum.posit.co/)
  or [Stack Overflow](https://stackoverflow.com/), where more people can
  help.
- For bugs, [file an
  issue](https://github.com/ropensci/cffr/issues/new).
...
requests](https://github.com/ropensci/cffr/issues) to make sure the bug
has not already been reported or fixed in the development version. By
default, the search is pre-populated with `is:issue is:open`. You can
[edit the
...
**cffr** is maintained by volunteers, so a response may not be
