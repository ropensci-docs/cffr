...
- Your `inst/CITATION` file, when available.
...
metadata. The validation step reports any values that do not satisfy the
CFF schema so that they can be corrected in their original metadata
source.
...
You can display the valid keys from the [Citation File Format schema
version
...
#> ✔ '/tmp/RtmpSHhiSu/filefc47774ed90.cff' generated.
#> ══ Validating CFF ══════════════════════════════════════════════════════════════
#> ✔ '/tmp/RtmpSHhiSu/filefc47774ed90.cff' is valid.
...
#> ✔ '/tmp/RtmpSHhiSu/filefc46a2549ff.cff' generated.
#> ══ Validating CFF ══════════════════════════════════════════════════════════════
#> ✔ '/tmp/RtmpSHhiSu/filefc46a2549ff.cff' is valid.
